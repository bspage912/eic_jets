...
dest=/gpfs/mnt/gpfs02/eic/bpage/testWTA
...
do 
    ...
    ./createJetTrees_testWTA.exe 1000000 0 250000 $path/pythia.ep.20x250.1Mevents.RadCor=0.Q2=10.0-100.0.kT=1.0_$number.root /data1/pagetmp/jetTree.ep.20x250.1Mevents.RadCor=0.Q2=10.0-100.0.kT=1.0_$number.A.root
    ./createJetTrees_testWTA.exe 1000000 250000 500000 $path/pythia.ep.20x250.1Mevents.RadCor=0.Q2=10.0-100.0.kT=1.0_$number.root /data1/pagetmp/jetTree.ep.20x250.1Mevents.RadCor=0.Q2=10.0-100.0.kT=1.0_$number.B.root
    ./createJetTrees_testWTA.exe 1000000 500000 750000 $path/pythia.ep.20x250.1Mevents.RadCor=0.Q2=10.0-100.0.kT=1.0_$number.root /data1/pagetmp/jetTree.ep.20x250.1Mevents.RadCor=0.Q2=10.0-100.0.kT=1.0_$number.C.root
    ./createJetTrees_testWTA.exe 1000000 750000 1000000 $path/pythia.ep.20x250.1Mevents.RadCor=0.Q2=10.0-100.0.kT=1.0_$number.root /data1/pagetmp/jetTree.ep.20x250.1Mevents.RadCor=0.Q2=10.0-100.0.kT=1.0_$number.D.root
