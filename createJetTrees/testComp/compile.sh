#g++ -Wall -ggdb `root-config --cflags --libs` `fastjet-config --cxxflags --libs --plugins` -I/afs/rhic.bnl.gov/eic/include/ -I/afs/rhic.bnl.gov/eic/env/new/include/ -I/eic/u/bpage/epJets/createJetTrees/StEpSimuJetMaker -L/afs/rhic.bnl.gov/eic/lib -L/eic/u/bpage/epJets/createJetTrees/StEpSimuJetMaker -leicsmear -lStEpSimuJetEvent createJetTrees_aktR1.0_v3.cxx -o createJetTrees_aktR1.0_v3.exe
...
#g++ -Wall -ggdb `root-config --cflags --libs` `fastjet-config --cxxflags --libs --plugins` -I$EICDIRECTORY/include/ -I/eic/u/bpage/epJets/createJetTrees/testComp/StEpSimuJetMaker -L/afs/rhic.bnl.gov/eic/lib -L/eic/u/bpage/epJets/createJetTrees/testComp/StEpSimuJetMaker -leicsmear -lStEpSimuJetEvent createJetTrees_testWTA.cxx -o createJetTrees_testWTA.exe


g++ -Wall -ggdb `root-config --cflags --libs` `fastjet-config --cxxflags --libs --plugins` -I$EICDIRECTORY/include/ -I/eic/u/bpage/epJets/createJetTrees/testComp/StEpSimuJetMaker -L$EICDIRECTORY/lib -L/eic/u/bpage/epJets/createJetTrees/testComp/StEpSimuJetMaker -leicsmear -lStEpSimuJetEvent createJetTrees_testWTA.cxx -o createJetTrees_testWTA.exe


#g++ -Wall -ggdb `root-config --cflags --libs` -I/eic/u/bpage/epJets/createJetTrees/testComp/StEpSimuJetMaker -L/eic/u/bpage/epJets/createJetTrees/testComp/StEpSimuJetMaker -lStEpSimuJetEvent analyzeTest.cxx -o analyzeTest.exe
